...
**本ハンドブックは、以下を目的として執筆されました。**  

* 素早く使用できる R のマニュアルとして機能する  
* 疫学業務や研究で頻繁に直面する課題に対する対処法を事例として紹介する  
* R に移行する疫学者や疫学実務者を支援する  
* インターネットに接続できない環境でも、**[オフライン版](#data-used)** を使用できるようにする  


**本書は他の言語でも利用できます:** [英語 (English)](https://epirhandbook.com/en/), [ベトナム語 (Tiếng Việt)](https://epirhandbook.com/vn/)  
...
* 公式ウェブサイトは **[こちら](http://www.appliedepi.org)** メーリングリストへの登録は **[こちら](https://forms.gle/9awNd8syypTSYUsn7)**  
* メールでのお問い合わせ先： **contact@appliedepi.org** 
* ツイッター： **[\@epiRhandbook](https://twitter.com/epirhandbook)**（英語） **[\@epiRhandbook_jp](https://twitter.com/epirhandbook_jp)**（日本語）
* Github でのイシュー（Issue）の作成は、**[こちら](https://github.com/appliedepi/epiRhandbook_eng)**  

また、数十年にわたる疫学や疫学実務の経験を持つ講師による**リアルタイムの R トレーニング**も提供しています。ご興味のある方は、メールでご相談ください。
:::
...
* 更に詳しいマニュアルや参考資料は、各章の「参考資料」セクションを参照してください。  
...
このハンドブックは、世界各地の疫学者や疫学実務者の協力により、地方、州、県、国の各保健機関、世界保健機関（World Health Organization; WHO）、国境なき医師団（Médecins Sans Frontières; MSF）、病院や学術機関などでの経験をもとに作成されています。
...
本ハンドブックを、授業や疫学者養成研修プログラム等の一環として学生や研修生のために使用するのに問題はありませんが、その際はメールでお知らせください。使用用途について質問や疑問点がございましたら、**epiRhandbook@gmail.com** までご連絡ください。  
...
本書の内容に貢献したい方は、まず Github issues またはメールにてご連絡ください。現在、本書の更新スケジュールやコントリビューターガイドを作成中です。 
