...
We see that the survival curve for women and the one for men overlap and the log-rank test does not gives enough evidence of a statistical difference between the survival for women and the survival for Men at `alpha = 0.05`.
