...
既に割り当てられたネットワークドライブに保存されたファイルを開きたい場合は、[こちらの](https://stackoverflow.com/questions/48161177/r-markdown-openbinaryfile-does-not-exist-no-such-file-or-directory/55616529?noredirect=1#comment97966859_55616529) Stack Overflow のページに記載されている対処法を参照してください。
...
-   上の 3 つの対処法のいづれも成功しなかった場合、インストールしたいパッケージを別のライブラリやフォルダ（Temp など）にインストールし、インストール後にそのパッケージが保存されたフォルダを、R がアクセスするライブラリに移してみてください。
