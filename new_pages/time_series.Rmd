...
data <- read_ncdf(file_paths[1]) + read_ncdf(file_paths[2]) + read_ncdf(file_paths[4]) + read_ncdf(file_paths[5]) + read_ncdf(file_paths[6]) + read_ncdf(file_paths[8]) + read_ncdf(file_paths[9]) + read_ncdf(file_paths[10])
```
