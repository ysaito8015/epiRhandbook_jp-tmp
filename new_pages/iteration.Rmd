...
-   `export()` で指定するファイルパスには、 `str_glue()` を使用して各病院名を適用します（`str_glue()` に関する詳細は、[文字列型データ](#characters-strings) の章を参照ください）。
...
[purrr の役立つヒント](https://www.hvitfeldt.me/blog/purrr-tips-and-tricks/)
