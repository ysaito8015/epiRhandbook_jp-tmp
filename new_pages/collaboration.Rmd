...
To synchronize these repositories, we will use more functions:

-   \
    \

-   *Pull* and *push* - these are how the REMOTE repository syncs
    changes with the LOCAL repository\
...
-   To *merge* - To adopt changes from one branch into another (e.g.
    into "main"), you *merge* one branch into the other.\
