...
_Note_: if you do not have contributing rights on a Github repository, it is possible to first _fork_ the repository to your profile, and then proceed with the other actions. Forking is explained at the end of this chapter, but we recommand that you read the other sections first, because it will use all concepts explained in it.
