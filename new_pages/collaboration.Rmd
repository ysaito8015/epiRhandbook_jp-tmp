...
to learn the tools. But learning can be achieved by steps. Once a couple
of notions are acquired, the workflow can be quite efficient and fast.
...
For more information about the use of the console, see the section on
Git command at the end.
