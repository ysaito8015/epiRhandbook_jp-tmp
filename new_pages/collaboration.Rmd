...
Google Document, but for all types of files and more powerfull. It has
been developed by Linus Tovald to help work and collaboration during the
development the Linux kernel. It is one of the main modern options for
powerful version control.

### Why have I never heard of it?

While people with a developer background routinely learn to use version
control software (Git, Mercurial, Subversion or others), these skills
are rarely taught in more quantitative study tracks. Consequently, most
epidemiologists never hear of it during their studies, and have to learn
it on the fly.

### Wait, I heard of Github, is it the same?

Not exactly, but you often use them together.
...
-   If you want to store your folder in a **host website** to
    collaborate with others, you may create an account at Github, or
    Gitlab, Bitbucket (and others).

So you could use **Github Desktop**, which uses **Git** in the
background to manage your files, both locally on your computer, and
remotely on a **Github** server.
...
-   a file model_1.R and another file model_1\_test.R and a file
    model_1\_not_working.R?

-   a file *report.Rmd*, a file *report_fill.Rmd*, a file
    *report_true_final.Rmd*, a *file report_final_20210304.Rmd*, a file
    *report_final_20210402.Rmd.*
...
-   having many versions on several collaborator's computer

-   "Oups, I made all modifications on the wrong version of the file"
...
It can be. However, much like R, or even Excel, you don't need to become
an expert to rip out the benefits of the tool. Indeed, Git is one of the
most powerful version control software of this moment, it is used by
people working on massive coding projects and was developed to solve
complex challenges. So the advanced cases can get horribly scary.
However, learning a *small number of functions* can let you track your
changes, synchronize your files on a online repository and collaborate
with your colleagues in a very short amount of time.
...
There are many interfaces. Good options for beginners include:
...
-   To *clone* - to create a copy of a Github repository locally on your
    computer (could manifest as an R project)\

-   When you have cloned a repository, the project files will then exist
    in two places:

    -   *REMOTE* - the versions of your project files that exist online
        in the Github repository\
    -   *LOCAL* - this is a *clone* of the online repository that exists
        on your physical computer. This is where you make the actual
        changes to the files/code.\

-   *Pull* and *push* - these are how the REMOTE repository syncs
    changes with the LOCAL repository\

-   *Branches* - these are parallel, alternate versions of your project
    files

    -   The *"main" branch* is the primary/final/"live" version of your
        files\
    -   Other branches are made to test changes before they are
        incorporated into the "main" branch\

-   A *commit* - is a trackable unit of changes (the delta) made to your
    files. For example, perhaps you edit some lines of code and update a
    related dataset. Once your changes are saved, you can bundle these
    changes togeher into one "commit". For version control purposes, you
    can revert your project back in time based on commits, so it is best
    to keep them relatively small. You will also attach a brief
    description of the changes as the "commit message".\
