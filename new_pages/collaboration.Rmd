...
will then have an interface on Github website to discuss with other
collaborators about the branch, before merging (if any merging is
decided). For example, see pull request discussions on the [dplyr's
...
UNDER CONSTRUCTION - what do you wanted to put here?

### Forking

Explain it is a way of cloning, but in a repo with different access
rights
