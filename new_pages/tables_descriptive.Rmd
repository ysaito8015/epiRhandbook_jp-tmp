...
This page demonstrates the use of **janitor**, **dplyr**, **gtsummary**, and **base** R to summarise data and create tables with descriptive statistics. 
...
* Use `tabyl()` from **janitor** to produce and "adorn" tabulations and cross-tabulations.
  * Cons: requires post-processing (e.g with **flextable**) for publication-ready tables.  
