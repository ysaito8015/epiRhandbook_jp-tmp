...
We offer an R package called **handbookfiles**. It includes a function `download_book()` that downloads the handbook file from our Github repository to your computer.  

This package also contains a function `get_data()` that downloads all the example data to your computer.  


To install our R package **handbookfiles**, run the following code. This package is not on CRAN, so use the function `p_install_gh()` to install it from our [*epirhandbook* Github page](https://github.com/epirhandbook/handbookfiles).   
