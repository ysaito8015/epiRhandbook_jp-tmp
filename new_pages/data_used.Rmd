...
You can download the offline version of this handbook as an HTML file so that you can view the file in your web browser even if you no longer have internet access.  

Note: The file is large (>40MB). When you open it, it may take several minutes for the images and the Table of Contents to load. Additionally, the offline handbook displays as one long page, so please search for specific content using with Ctrl+f (Cmd-f). 
...
To "follow along" with the pages, you can download the datasets and use them yourself. See the instructions for download below. All the data in this handbook are available from the **["data" folder](https://github.com/epirhandbook/Epi_R_handbook/tree/master/data)** of our Github repository.  
