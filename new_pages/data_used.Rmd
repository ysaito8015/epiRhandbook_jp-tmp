...
Run the following code to install our R package **handbookfiles** from the [Github repository *epirhandbook*](https://github.com/epirhandbook/handbookfiles). This package is not on CRAN, so use the special function `p_install_gh()` to install it from Github.  
