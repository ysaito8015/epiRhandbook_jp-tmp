...
The easiest approach to download all the data is to install our R package **handbookfiles**. It contains a function `get_data()` that saves all the example data to a folder of your choice on your computer.  
